...
<div class="container-fluid">
    ...
    <div class="col-9"><br>
<h3 class="text-center">List of Branches</h3><br>
    <div class="jumbotron">
    ...
    <table id="branch_data"  class="table table-striped table-bordered">
    <thead>
    <tr>
        <th>S/N</th>
		<th>City Name</th>
    ...
    <?php 
       if (isset($_POST['delete'])) {
        $id = $_POST['id'];
               ...
               if ($result) {?>
                   <h5 class="text-success">Branch was successfully removed.</h5>
               <?php }else {?>
                   <h5 class="text-danger">Branch could not be removed.</h5>
               <?php }
           }
    ...
    while ($row=mysqli_fetch_assoc($result)) {?>
        ...
        <tr>
            ...
            <input name="id" class="d-none" value="<?php echo $row['id']?>" >
                <button class="btn btn-danger btn-sm" name="delete" onclick= "return confirm('Are you sure you want to remove this branch?')" type="submit">Delete</button>
            </form>
            </td>
        </tr>
...
<script>
    ...
    $('#branch_data thead tr')
        .clone(true)
        .addClass('filters')
        .appendTo('#branch_data thead');
